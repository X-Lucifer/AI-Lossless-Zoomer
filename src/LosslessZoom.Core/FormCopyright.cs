...
namespace LosslessZoom.Core
{
    public partial class FormCopyright : UIForm
    {
        ...
        {
            txtInfo.Text = @"本程序可供个人/企业/学校/政府机关等自由场合任意安装和使用。
            * 注意事项
             - 本程序受著作权法和软件保护法的保护，除保护法条款中允许或非限制的范围以外，
                任何人对本程序进行的逆向工程、反编译、重新组装都将被视为违法。
            ...
            * 版权信息
             ...
             - 本程序使用的 SunnyUI 开源控件库是直接从 https://github.com/yhuse/SunnyUI 下载的，并遵循 MIT License 公共许可协议。
